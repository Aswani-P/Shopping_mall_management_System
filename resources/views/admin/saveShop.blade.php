                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('saved')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="shopname" name="shopname"value="{{$shops->shop_name}}" >
                        </div>
                        <div class="mb-3">
                            <label for="location" class="form-label">Location</label>
                            <input type="text" class="form-control" id="location" name="location"value="{{$shops->location}}"/>

                        </div>
                        <div class="mb-3">
                            <label for="ownername" class="form-label">Contact Number</label>
                            <input type="text" class="form-control" id="owner" name="number"value="{{$shops->contact}}" />
                        </div>
                        <div class="mb-3">
